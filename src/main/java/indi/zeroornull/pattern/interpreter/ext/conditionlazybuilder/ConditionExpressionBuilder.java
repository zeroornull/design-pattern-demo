...
import indi.zeroornull.pattern.interpreter.ext.conditionlazybuilder.expression.AndExpression;
import indi.zeroornull.pattern.interpreter.ext.conditionlazybuilder.expression.EqualsExpression;
import indi.zeroornull.pattern.interpreter.ext.conditionlazybuilder.expression.Expression;
import indi.zeroornull.pattern.interpreter.ext.conditionlazybuilder.expression.OrExpression;
