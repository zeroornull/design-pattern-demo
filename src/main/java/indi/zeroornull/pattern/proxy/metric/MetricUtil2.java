...
@Slf4j
public final class MetricUtil2 {
     ...
     * @return 目标方法执行结果
     */
    public static <T> T metric(Callable<T> targetMethod, MetricTagSetter<T> metricTagSetter) throws Exception {
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        T result = targetMethod.call();
        stopWatch.stop();
        try {
