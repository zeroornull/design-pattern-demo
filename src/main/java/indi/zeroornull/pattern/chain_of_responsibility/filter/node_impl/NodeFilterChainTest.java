package indi.zeroornull.pattern.chain_of_responsibility.filter.node_impl;
...
import indi.zeroornull.pattern.chain_of_responsibility.filter.node_impl.filter.AFilter;
import indi.zeroornull.pattern.chain_of_responsibility.filter.node_impl.filter.BFilter;
import indi.zeroornull.pattern.chain_of_responsibility.filter.node_impl.filter.CFilter;
import indi.zeroornull.pattern.chain_of_responsibility.filter.node_impl.filter.DFilter;
